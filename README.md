...
I build reliable AI workflows and automation systems in Python and JavaScript.

My work sits between model calls and real operations: retrieving context, coordinating APIs, validating structured output, handling failures, and keeping side effects reviewable and safe to rerun.

## Featured work

### [OutreachOS](https://github.com/Adedoyin2005/outreachos)
...
- Clear trust boundaries around model and retrieved content
- Structured outputs before downstream actions
- Timeouts, bounded retries, logs, and explicit failure behavior
- Human approval where automation should not make the final call
